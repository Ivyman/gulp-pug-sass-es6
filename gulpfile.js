'use strict';
// $ touch package.json           ==> create package.json
// $ npm init                     ==> fill data to package.json
// $ npm install gulp --save-dev  ==> install gulp locally for a current project
// $ touch gulpfile.js            ==> create gulpfile.js
